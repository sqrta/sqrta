...
Proof.
  ...
  - induction l as [| n l' h'].
    ...
    + simpl. intros [h1 | h2].
      ...
      * apply h' in h2. destruct h2 as [u [hl hr]].
        exists u. {
          split.
          - apply hl.
          - right. apply hr.
  ...
  - induction l as [| n l' h'].
    + simpl. intros [x [h1 h2]]. destruct h2.
    + simpl. intros [x [a [c | d]]].
      * left. rewrite <- c in a. apply a.
...
Proof.
  ...
  - induction l.
    ...
    + simpl. intros [[c | d] | e].
      * left. apply c.
      * right. apply IHl. left. apply d.
      *  right. apply IHl. right. apply e.
